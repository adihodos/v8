...
public :
    ...
    /**
     * \fn  matrix4X4::matrix4X4( const gfx::vector4<real_t>& v1, const gfx::vector4<real_t>& v2,
     * const gfx::vector4<real_t>& v3, const gfx::vector4<real_t>& v4, bool column = true );
     *
...
template<typename real_t>
const gfx::matrix_4X4<real_t>
gfx::matrix_4X4<real_t>::null(
...
template<typename real_t>
const gfx::matrix_4X4<real_t>
    gfx::matrix_4X4<real_t>::identity(
